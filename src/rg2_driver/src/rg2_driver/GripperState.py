...
class GripperJointStates():
    ...
    def __init__(self, robot_ip: str, prefix: str, sufix: str) -> None:
        ...
        self.state_publisher  = rospy.Publisher(namespace+"rg2/joint_states", JointState, queue_size=10)
        self.grip_publisher  = rospy.Publisher(namespace+"rg2/grip_detected", Bool, queue_size=10)
        ...
        self.joints.name = [prefix+x+sufix for x in self.joints.name]
...
if __name__ == "__main__":
    ...
    prefix = sys.argv[2]
    sufix = sys.argv[3]
    gripper_joint_state_publisher = GripperJointStates(robot_ip, prefix, sufix)
